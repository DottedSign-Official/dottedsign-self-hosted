class CompletedFileGenerator < ServiceCaller
  ...
  def annotate
    ...
    generator = KmpdfTool::PdfAnnotateGenerator.call(@task.field_settings, @readable_path)
  ...
  def system_time
    ...
    generator = KmpdfTool::ReadableFileGenerator::VisibleSystemtimeGenerator.call(@task, working_dir: File.dirname(@readable_path))
