...
RSpec.describe Doorkeeper::TokensController, type: :request do
  ...
  before(:each) do |example|
    ...
    example.metadata[:rpdoc_action_name] = 'Login'
  ...
  describe '#tasks' do
    ...
    it 'should return 200', rpdoc_example_key: 200, rpdoc_example_name: 'login success' do
    ...
    it 'should return 401_001 if password is incorrect', rpdoc_example_key: 401_001, rpdoc_example_name: 'login failed (password incorrect)' do
