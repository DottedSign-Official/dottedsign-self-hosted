...
RSpec.describe Api::V1::SystemCasController, type: :request do
  ...
  before(:each) do |example|
    ...
    example.metadata[:rpdoc_action_name] = 'show system detail'
  ...
  describe '#show', mock_default_group: true do

    it 'should return 200 and get system ca', rpdoc_example_key: 200, rpdoc_example_name: 'show sysmem ca success' do
