...
Doorkeeper.configure do
  ...
  resource_owner_from_credentials do
    ...
    raise CustomDoorkeeperError, :third_party_no_email
  rescue LeveretAuth::Errors::StrategyNotFound
    raise CustomDoorkeeperError, :strategy_not_found
  rescue LeveretAuth::Errors::InvalidCredential
    raise CustomDoorkeeperError, :invalid_grant
  end
...
Rails.application.reloader.to_prepare do
  Doorkeeper::ApplicationController.include(ResponseHelper)
  Doorkeeper::OAuth::ErrorResponse.prepend(CoreExtensions::CustomDoorkeeperErrorResponse)
end

CustomDoorkeeperError = Class.new(Doorkeeper::Errors::DoorkeeperError)
